 ...
 * @author Sfiso
 */
public class frmAddNewAdmin extends javax.swing.JFrame {

    /**
     * Creates new form frmAddNewAdmin
     */
    ...
    private void initComponents() {
        ...
        jLabel4.setText("ADD ADMIN ACCOUNT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAddNewAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmAddNewAdmin().setVisible(true);
            }
        });
    }
